...
#include "../build/MAIN/CVTBasedNewton.cpp"
...
typedef std::pair<Point11, Kernel::Vector_3> Pwn;
typedef CGAL::Polyhedron_3<Kernel> Polyhedron11;



int rnnnum = 80;
//get a random num in [-1,1]
double rand_num()
{
...
//		
		...
		// mesh to feature 
		// very sample.
		//ofstream outFeatureLine("FeatureLine_whitePrinter-simple.obj");
		//
		//MyHalfEdgeModel FinalModel;
		//FinalModel.ReadObjFile("whitePrinter-simple.obj");
		...
		//{
		//	outFeatureLine << "v " << Fvecs[i].transpose() << endl;
	...
	*/
		...
		//random revise normal
		//ifstream infile("E:\\Dropbox\\MyProjects\\SIG-2022-Feature-preserving-recon\\data\\Result_100models\\00043413_67f276d67b3c4e3ea75835fe_trimesh_000\\01_00043413_67f276d67b3c4e3ea75835fe_trimesh_000.xyz");
		//ofstream outfile("E:\\Dropbox\\MyProjects\\SIG-2022-Feature-preserving-recon\\data\\Result_100models\\00043413_67f276d67b3c4e3ea75835fe_trimesh_000\\01_00043413_67f276d67b3c4e3ea75835fe_trimesh_000_revise20.xyz");
		//Eigen::Vector3d v;
		//Eigen::Vector3d n;
		...
		//		n.z() *= -1;
		//	}
		//	//Eigen::Vector3d n_revise = n.normalized();
		//	outfile << v.transpose() << " " << n.transpose() << endl;
		//}
		//outfile.close();
